...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFDDA15E);
  late Color secondary = const Color(0xFFBC6C25);
  late Color tertiary = const Color(0xFF606C38);
  late Color alternate = const Color(0xFF283618);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFFEFAE0);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x4CDDA15E);
  late Color accent2 = const Color(0x4DBC6C25);
  late Color accent3 = const Color(0x4D606C38);
  late Color accent4 = const Color(0x4D283618);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFFFFFFFF);

  late Color mapColor = const Color(0xFFEBE3CD);
